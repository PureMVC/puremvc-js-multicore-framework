...
* IFacade to act as a central point of communication
* for a subsystem. </P>
*
* <P>
...
*
* @see org.puremvc.js.interfaces.IModel IModel
* @see org.puremvc.js.interfaces.IView IView
* @see org.puremvc.js.interfaces.IController IController
* @see org.puremvc.js.interfaces.ICommand ICommand
...
function class_org_puremvc_js_interfaces_IFacade()
{
	...
	*/
	 ...
	 * @param commandIFacadeRef a reference to the <code>IFacade</code> of the <code>ICommand</code>.
	 */
	o.registerCommand = function( noteName/*String*/, commandIFacadeRef/*IFacade*/ ){};
