...
(
	{
  		...
  		testGetInstance: function()
		{
   			...
   			// Test Factory Method
   			var view/*View*/ = View.getInstance('ViewTestKey1');
  		...
  		testRegisterAndNotifyObserver: function()
		{
  			...
  			var view/*View*/ = View.getInstance('ViewTestKey2');
		...
		testRegisterAndRetrieveMediator: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey3');
  		...
  		testHasMediator: function()
		{
   			...
   			// register a Mediator
   			var view/*View*/ = View.getInstance('ViewTestKey4');
		...
		testRegisterAndRemoveMediator: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey5');
		...
		testOnRegisterAndOnRemove: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey6');
		...
		testSuccessiveRegisterAndRemoveMediator: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey7');
		...
		testRemoveMediatorAndSubsequentNotify: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey8');
		...
		testRemoveOneOfTwoMediatorsAndSubsequentNotify: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey9');
		...
		testMediatorReregistration: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey10');
		...
		testModifyObserverListDuringNotification: function()
		{
  			...
  			// Get the Singleton View instance
  			var view/*View*/ = View.getInstance('ViewTestKey11');
