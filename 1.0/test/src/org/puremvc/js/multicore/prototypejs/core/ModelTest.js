...
(
	{
       ...
       /**
		...
		{
   			// Test Factory Method
   			var model/*Model*/ = Model.getInstance('ModelTestKey1');
  		...
  		testRegisterAndRetrieveProxy: function()
		{
   			...
   			var model/*Model*/ = Model.getInstance('ModelTestKey2');
  		...
  		testRegisterAndRemoveProxy: function()
		{
   			...
   			var model/*Model*/ = Model.getInstance('ModelTestKey3');
		...
		{
   			// register a proxy
   			var model/*Model*/ = Model.getInstance('ModelTestKey4');
