 ...
 *
 * @see org.puremvc.js.multicore.prototypejs.patterns.facade.FacadeTestVO
 * @see org.puremvc.js.multicore.prototypejs.patterns.facade.FacadeTestCommand
 */
...
(
	{
       ...
       /**
		...
		{
   			// Test Factory Method
   			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey1');
   			
   			// test assertions
   			YUITest.Assert.isNotUndefined
			(
				facade,
				"Expecting something to be returned that is not undefined"
			);
  		...
  		testRegisterCommandAndSendNotification: function()
		{
   			...
   			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey2');
  		...
  		testRegisterAndRemoveCommandAndSendNotification: function()
		{
   			...
   			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey3');
   			facade.registerCommand( 'FacadeTestNote', FacadeTestCommand );
  		...
  		testRegisterAndRetrieveProxy: function()
		{
   			...
   			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey4');
  		...
  		testRegisterAndRemoveProxy: function()
		{
   			...
   			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey5');
  		...
  		testRegisterRetrieveAndRemoveMediator: function()
		{
   			...
   			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey6');
		...
		{
   			// register a Proxy
			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey7');
		...
		{
   			// register a Mediator
			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey8');
  		...
  		testHasCommand: function()
		{
   			...
   			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey10');
  		...
  		testHasCoreAndRemoveCore: function()
		{
			...
			(
   			...
   			// register a Core
			var facade/*Facade*/ = Facade.getInstance('FacadeTestKey11');
