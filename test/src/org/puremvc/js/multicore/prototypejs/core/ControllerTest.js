...
(
	{
		...
		{
			// Test Factory Method
			var controller/*Controller*/ = Controller.getInstance('ControllerTestKey1');
		...
		testRegisterAndExecuteCommand: function()
		{
			...
			var controller/*Controller*/ = Controller.getInstance('ControllerTestKey2');
		...
		{
			// Create the controller, register the ControllerTestCommand to handle 'ControllerTest' notes
			var controller/*Controller*/ = Controller.getInstance('ControllerTestKey3');
		...
		testHasCommand: function()
		{
			...
			var controller/*Controller*/ = Controller.getInstance('ControllerTestKey4');
		...
		testReregisterAndExecuteCommand: function()
		{
			...
			var controller/*Controller*/ = Controller.getInstance('ControllerTestKey5');
			...
			var view/*View*/ = View.getInstance('ControllerTestKey5');
