 ...
 */
Puremvc.test.ControllerTestCommand = Ext.extend(Puremvc.patterns.SimpleCommand,
/**
 * @lends Puremvc.test.ControllerTestCommand.prototype
 */
{
  /**
...
Alias('Puremvc.test.ControllerTestCommand');
