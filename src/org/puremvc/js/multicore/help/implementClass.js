     ...
     */
    function implementClass (classInfo, traits, staticTraits)
    {
        if (null == classInfo)
        {
            classInfo= {}
        ...
        if (null != traits)
        {
            ...
            // prevent override of reassign constructor 
