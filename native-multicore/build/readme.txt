...
STEP 3: RUNNING THE UNIT TESTS (SIMPLE)
    ...
    * From within Eclipse...
	  ...
	  mode and be able to access it over your physical or virtual network. 
	  ...
	  To begin, you must first pick a port number and start the test server via 
	  ...
	  $ java -jar JsTestDriver-1.3.4.b.jar --port <PORTNUMBER> &
      ...
      $ java -jar JsTestDriver-1.3.4.b.jar --config ../config/testdriver.conf
      
      $ java -jar JsTestDriver-1.3.4.b.jar --config ../config/testdriver-compiled.conf
